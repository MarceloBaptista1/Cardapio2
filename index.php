...
<html lang="pt-BR">
	...
	<body>
		<header class="w-full h-[420px] bg-zinc-900 bg-home bg-cover bg-center">
			...
			>
				...
				<span class="text-white font-medium"
					>Rua Bola, 671 Santos - SP</span
				>

				<div
					class="bg-green-600 px-4 py-1 rounded-lg mt-5"
					id="date-span"
				>
					<span class="text-white font-medium"
						>Seg á Dom - 18:00 as 23:00</span
					>
				</div>
			</div>
		</header>
		...
		<div
			class="bg-black/70 w-full h-full fixed top-0 left-0 z-[99] items-center justify-center hidden"
			id="cart-modal"
		>
			<div class="bg-white p-5 rounded-md min-w-[90%] md:min-w-[600px]">
				...
				<div
					id="cart-items"
					class="flex justify-between mb-2 flex-col"
				...
				<div class="mt-4">
					<form>
						...
						<select
							...
							style="border-radius: 0.25rem; padding: 10px"
						>
		...
		<!-- FINISH MODAL EDIT PRODUCTS-->

		<!-- BOTÃO CART FOOTER -->

		<footer
			class="w-full bg-red-500 py-2 fixed bottom-0 z-40 flex items-center justify-center"
		>
			<button
